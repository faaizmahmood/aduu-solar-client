...
const UserProjects = () => {
    const { showModal, openModal, closeModal, handleSubmit, projects, fetchProjects, getStatusColor, loading } = useProjects();
                                            ...
                                            onClick={() =>
                                                project.status === 'Pending'
                                                    ...
                                                    : (project.status === 'Awaiting Assignment' ?
                                                        toast.warning("Awaiting Staff Assignment!")
                                                        : navigate(`/projects/project-details/${project._id}`, { state: { project } })
                                                    )
                                            }
